 ...
 */
public class ConnectedHouseBuilderImpl implements ConnectedHouseBuilder {
    ...
    @Override
    public void addRoom(RoomType roomType, List<String> featureNames) throws InvalidModelConfigurationException {
